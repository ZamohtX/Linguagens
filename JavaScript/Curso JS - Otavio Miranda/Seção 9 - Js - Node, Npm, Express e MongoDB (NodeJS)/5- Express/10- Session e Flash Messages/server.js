...
/*                    
        Session -> Salvando dados do navegador do cliente na Base de Dados para diversos meios
                Exemplo: Identificar o usuario

        Flash Messages -> Mensagens que são salvas na sessão
*/
