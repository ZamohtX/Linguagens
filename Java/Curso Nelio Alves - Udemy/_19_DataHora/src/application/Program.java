...
public class Program {
	...
	public static void main(String[] args) {
		...
		// Duração
			// Dias
		Duration t1 = Duration.between(proxHora, d05);
		System.out.println(t1.toDays());
		
		Duration t2 = Duration.between(semanaPassada.atStartOfDay(), d04.atTime(0,0));
