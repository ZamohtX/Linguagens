...
class Game:
    ...
    def carregar_arquivos(self):
        ...
        self.dirtorio_audios = os.path.join(os.getcwd(), 'audios')
    ...
    def mostrar_tela_start(self):
        ...
        pygame.mixer.music.load(os.path.join(self.dirtorio_audios, constantes.MUSICA_START))
        ...
        self.mostrar_texto(
            'Desenvolvido por Thomaz Xavier',
            19,
            constantes.BRANCO,
            constantes.LARGURA / 2,
            570
        ...
        while esperando:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYUP:
                    ...
                    pygame.mixer.Sound(os.path.join(self.dirtorio_audios,constantes.TECLA_START)).play()
